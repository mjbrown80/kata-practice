...
public class PermutationDifferenceBetweenStrings {
...
//    s consists only of lowercase English letters.
    ...
    public static void main(String[] args){
        ...
        System.out.println("Expected: 2 | Actual: " + permutationDifference("abc", "bac"));
        System.out.println("Expected: 12 | Actual: " + permutationDifference("abcde", "edbac"));
        System.out.println("Expected: 14 | Actual: " + permutationDifference("abcdef", "fbedca"));
    }
